        ...
        <div style="margin-top: 10px">
            <el-table :data="salaries" border stripe>
                ...
                <el-table-column label="养老金" align="center">
                    <el-table-column width="100" prop="pensionPer" label="比率"></el-table-column>
                    <el-table-column width="100" prop="pensionBase" label="基数"></el-table-column>
                </el-table-column>
                <el-table-column label="医疗保险" align="center">
                    <el-table-column width="100" prop="medicalPer" label="比率"></el-table-column>
                    <el-table-column width="100" prop="medicalBase" label="基数"></el-table-column>
                </el-table-column>
                <el-table-column label="公积金" align="center">
                    <el-table-column width="100" prop="accumulationFundPer" label="比率"></el-table-column>
                    <el-table-column width="100" prop="accumulationFundBase" label="基数"></el-table-column>
                </el-table-column>
