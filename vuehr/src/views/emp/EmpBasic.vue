    ...
    <div>
        <div>
            <div style="display: flex;justify-content: space-between">
                <!--            第一行的前三个按钮-->
                <div>
                    <el-input placeholder="请输入员工名进行搜索，可以直接回车搜索..." prefix-icon="el-icon-search" size="mini"
                              clearable
                              @clear="initEmps"
                              style="width: 350px;margin-right: 10px" v-model="keyword"
                              @keydown.enter.native="initEmps" :disabled="showAdvanceSearchView"></el-input>
                    <el-button type="primary" @click="initEmps" :disabled="showAdvanceSearchView" icon="el-icon-search" size="mini">搜索</el-button>
                    <el-button type="primary" icon="el-icon-search" size="mini" @click="showAdvanceSearchView = !showAdvanceSearchView">
                        <i :class="showAdvanceSearchView?'fa fa-angle-double-up':'fa fa-angle-double-down'"  aria-hidden="true"></i>高级搜索
                    </el-button>
                </div>
                <!--            第一行的后三个按钮-->
                <div>
                    <el-upload
                        ...
                        <el-button :disabled="importDataDisabled" type="success" size="mini" :icon="importDataBtnIcon">
                            {{importDataBtnText}}
                        </el-button>
                    </el-upload>
                    ...
                    <el-button type="success" icon="el-icon-plus" size="mini" @click="showAddEmpView">
                        添加用户
                    </el-button>
                </div>
            </div>
                    ...
                    <el-row>
                        ...
                        <el-col :span="5">
                            <el-form-item label="性别:" prop="gender">
                                <el-radio-group v-model="emp.gender" class="radio-group">
                    ...
                    <el-row>
                        ...
                        <el-col :span="8">
                            <el-form-item label="聘用形式:" prop="engageForm" >
                                <el-radio-group v-model="emp.engageForm" class="radio-group">
                                    <el-radio label="劳动合同">劳动合同</el-radio>
                                    <el-radio label="劳务合同">劳务合同</el-radio>
                                </el-radio-group>
                            </el-form-item>
                        ...
                        <el-col :span="8">
                            <el-form-item label="婚姻状况:" prop="wedlock">
                                <el-radio-group v-model="emp.wedlock" class="radio-group">
