...
public class POIUtils {
	...
	public static ResponseEntity<byte[]> employeeToExcel(List<Employee> list) {
		// 1. 获取数据
		HSSFWorkbook workbook = getEmployeeDateWorkbook(list);
	...
	public static HSSFWorkbook getEmployeeDateWorkbook(List<Employee> data) {
		//1.创建一个excel文档
		HSSFWorkbook workbook = new HSSFWorkbook();
		//生成文档基本信息
		genBaseInfo(workbook);
		// 生成数据
		genExcelSheet(workbook, data);
		return workbook;
	}

	public static void genBaseInfo(HSSFWorkbook workbook){
		// 2. 创建文档摘要
		...
		// 设置公司信息
		docInfo.setCompany("www.cxyxh.com");
		// 4. 获取文档摘要信息
		SummaryInformation summInfo = workbook.getSummaryInformation();
		// 文档标题
		summInfo.setTitle("员工信息表");
		// 文档作者
		summInfo.setAuthor("程序员小黄");
		// 文档备注
		summInfo.setComments("本文档由 程序员小黄 提供");
	}

	private static void genExcelSheet(HSSFWorkbook workbook, List<Employee> data) {
	...
	public static void genExcelColumWidth(HSSFSheet sheet){
		//设置列的宽度
	...
	public static void genExcelDataRow(HSSFWorkbook workbook, HSSFSheet sheet,List<Employee> list){
